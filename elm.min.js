...
var $author$project$Main$generateDays = F2(
	function (zone, current) {
		return A2(
			$elm$core$List$map,
			function (d) {
				return {date: d, ranges: _List_Nil};
			},
...
var $author$project$Edit$init = function (ranges) {
	return {
		errorMessage: '',
		ranges: $elm$core$List$isEmpty(ranges) ? _List_fromArray(
			[
				{
...
var $author$project$Main$validateConsecutiveRanges = function (ranges) {
...
var $author$project$Main$validateEachRanges = function (ranges) {
	return A2(
		$elm$core$List$all,
		function (r) {
...
var $author$project$Main$validateRanges = function (ranges) {
	return A2(
		$elm$core$Result$andThen,
		$author$project$Main$validateConsecutiveRanges,
		$author$project$Main$validateEachRanges(ranges));
};
	...
	function (msg, model) {
		switch (msg.$) {
					...
					_Utils_update(
						model,
						{
							state: A2(
								...
								index,
								$author$project$Edit$init(day.ranges))
						}),
					$elm$core$Platform$Cmd$none);
			case 'EditMsg':
				var subMsg = msg.a;
			...
			default:
				var index = msg.a;
				var ranges = msg.b;
				var _v4 = $author$project$Main$validateRanges(ranges);
				if (_v4.$ === 'Ok') {
					var validatedRanges = _v4.a;
					var days = function () {
...
var $author$project$Edit$timeSelect = F3(
	function (times, selectedTime, msg) {
...
var $author$project$Edit$rangeView = F2(
			...
			_List_fromArray(
				[
					...
					A2(
						...
						A2($elm$core$List$indexedMap, $author$project$Edit$rangeView, model.ranges))),
					A2(
					$rtfeldman$elm_css$Html$Styled$button,
					_List_fromArray(
						[
...
var $author$project$Main$height = 25;
...
var $author$project$Main$frame = A2(
	...
	_List_fromArray(
		[
			...
			$author$project$Svg$Attributes$height($author$project$Main$height),
			$author$project$Svg$Attributes$rx(5),
			$author$project$Svg$Attributes$ry(5),
...
var $author$project$Main$tick = function (x) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Svg$Attributes$y2($author$project$Main$height),
				$rtfeldman$elm_css$Svg$Styled$Attributes$stroke('black')
			]),
		_List_Nil);
};
var $author$project$Main$ticks = A2(
	$elm$core$List$map,
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Svg$Attributes$width($author$project$Main$width),
				$author$project$Svg$Attributes$height($author$project$Main$height),
				A4($author$project$Svg$Attributes$viewBox, 0, 0, $author$project$Main$width, $author$project$Main$height)
			]),
		A2(
			$elm$core$List$cons,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$planningView(day.ranges)
						]))
				]));
	});
