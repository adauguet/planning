...
var $author$project$Main$generateDays = F2(
...
var $author$project$Edit$default = _List_fromArray(
	[
		{
		begin: _Utils_Tuple2(8, 30),
		code: $author$project$Code$T,
		end: _Utils_Tuple2(12, 30)
	},
		{
		begin: _Utils_Tuple2(14, 0),
		code: $author$project$Code$TT,
		end: _Utils_Tuple2(18, 0)
	}
	]);
...
var $author$project$Edit$newRange = {
	begin: _Utils_Tuple2(8, 0),
	code: $author$project$Code$T,
	end: _Utils_Tuple2(12, 0)
};
			...
			case 'GotZoneTime':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							days: A2($author$project$Main$generateDays, here, now),
...
var $author$project$Edit$validateConsecutiveRanges = function (ranges) {
	var validate = function (r) {
		if (r.b && r.b.b) {
			...
			var second = _v1.a;
			var tail = _v1.b;
			return (_Utils_cmp(first.end, second.begin) < 1) && validate(
...
var $author$project$Edit$validateEachRanges = function (ranges) {
	return A2(
		$elm$core$List$all,
		function (r) {
			return _Utils_cmp(r.begin, r.end) < 0;
		},
...
var $author$project$Main$frame = A2(
	...
	_List_fromArray(
		[
			...
			$rtfeldman$elm_css$Svg$Styled$Attributes$fill('#EDF2F7')
		]),
	_List_Nil);
...
var $author$project$Range$duration = function (range) {
	return $author$project$Range$toFloat(range.end) - $author$project$Range$toFloat(range.begin);
};
		...
		[
			...
			_List_fromArray(
				[
					...
					(($author$project$Main$width / $author$project$Main$numberOfHours) * $author$project$Range$duration(range)) - 6),
			...
			_List_fromArray(
				[
					...
					$author$project$Svg$Attributes$y(17),
